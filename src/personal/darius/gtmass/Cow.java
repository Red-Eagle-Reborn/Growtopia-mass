			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!tfg.equals("0")) {
					try {
				        ...
				        lblNewLabel.setText("Treasure Chest: " + trcs);
				        ...
				        lblNewLabel_1.setText("Ice: " + ices);
				        ...
				        lblNewLabel_3.setText("Dirt: " + dirts);
